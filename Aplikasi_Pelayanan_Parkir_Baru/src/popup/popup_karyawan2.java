...
public class popup_karyawan2 extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmod;
    
    public form_absensi fb_karyawan = null;
    
    public popup_karyawan2() {
        initComponents();
        data_table();
    ...
    private void tabel_karyawanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_karyawanMouseClicked
               try {
                ...
                fb_karyawan.str_nik= tabel_karyawan.getValueAt(tablepilih, 0).toString();
...
/**//**/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popup_karyawan2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popup_karyawan2().setVisible(true);
            }
        });
    }
