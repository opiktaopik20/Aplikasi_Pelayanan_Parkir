...
public class popup_karyawan1 extends javax.swing.JFrame {
    private Connection conn = new koneksi().connect();
    private DefaultTableModel tabmod;
    
    public form_penjualan_kartu fb_karyawan = null;
    
    public popup_karyawan1() {
        initComponents();
        data_table();
    ...
    protected void data_table() {
        Object[] Baris = {"NIK", "Nama Petugas","Jabatan"};
        tabmod = new DefaultTableModel (null, Baris);
        tabel_karyawan.setModel(tabmod);
        tabel_karyawan.setDefaultEditor(Object.class, null);
        String sql = "SELECT * FROM data_karyawan where jabatan='Car Park Manager' OR jabatan='Administrasi Pelayanan Parkir' OR jabatan='Assistant Car Park Manager'";
        try {
    ...
    private void tabel_karyawanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_karyawanMouseClicked
               try {
                int tablepilih = tabel_karyawan.getSelectedRow();
                fb_karyawan.str_nama = tabel_karyawan.getValueAt(tablepilih, 1).toString();
                fb_karyawan.itemTerpilih_karyawan();
    ...
    private void bcariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bcariActionPerformed
        ...
        tabel_karyawan.setModel(tabmod);
        tabel_karyawan.setDefaultEditor(Object.class, null);
        String sql = "select * from data_karyawan where nama like '%" + txt_cari.getText() + "%' or nik like '%" + txt_cari.getText() + "%'";
        try {
            java.sql.Statement stat = conn.createStatement();
            ResultSet hasil = stat.executeQuery(sql);
            while (hasil.next()) {
            ...
            int cek_hasil = tabel_karyawan.getRowCount();
            if (cek_hasil == 0) {
...
/**//**/
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popup_karyawan1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popup_karyawan1().setVisible(true);
            }
        });
    }
