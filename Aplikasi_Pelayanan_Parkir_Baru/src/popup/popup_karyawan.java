...
public class popup_karyawan extends javax.swing.JFrame {
    ...
    public form_tiket fa_karyawan = null;
    ...
    private void tabel_karyawanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_karyawanMouseClicked
               try {
                ...
                fa_karyawan.str_nik= tabel_karyawan.getValueAt(tablepilih, 0).toString();
                fa_karyawan.str_nama = tabel_karyawan.getValueAt(tablepilih, 1).toString();
                fa_karyawan.itemTerpilih_karyawan();
